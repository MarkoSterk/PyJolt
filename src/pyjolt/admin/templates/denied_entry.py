"""
Denied entry template for admin dashboard.
"""
    ...
    <body>
        <div class="card mt-4">
            <div class="card-header">
                <h5 class="title m-0">
                    <i class="fas fa-lock"></i> Permission Denied
                </h5>
            </div>
            ...
            <div class="card-body p-4 text-center">
                <div class="my-4">
                    ...
                    <h3 class="mb-3">Hold it right there!</h3>
                    <p class="text-muted fs-5">
                        Our security bot says you’re not on the guest list.<br>
